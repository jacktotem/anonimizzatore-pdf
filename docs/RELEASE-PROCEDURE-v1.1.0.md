...
> **Nota (v1.1.2):** questo file era originariamente `CHANGELOG.md` nella
> repo root. È in realtà una procedura di rilascio specifica per il salto
> v1.0.0 → v1.1.0, non un changelog. È stato rinominato in
> `docs/RELEASE-PROCEDURE-v1.1.0.md` come parte della issue N-06 (#10), e
> il nuovo `CHANGELOG.md` (Keep-a-Changelog) vive ora in repo root.
> Conservato per riferimento storico.
