...
; ========================================
;
; Per compilare: aprire questo file con Inno Setup Compiler
; (scaricabile gratis da https://jrsoftware.org/isdl.php)
; e cliccare "Build > Compile" (F9)
;
; Output: installer\AnonimizzatorePDF-Setup.exe
...
LicenseFile=
OutputDir=installer
OutputBaseFilename=AnonimizzatorePDF-Setup
...
; Script PowerShell per setup post-installazione
...
[Run]
; Esegue lo script PowerShell di setup dopo l'installazione dei file
Filename: "powershell.exe"; Parameters: "-ExecutionPolicy Bypass -NoProfile -File ""{app}\setup-dependencies.ps1"" -InstallPath ""{app}"""; \
    StatusMsg: "Configurazione di Python, Tesseract e dipendenze (può richiedere fino a 15 minuti)..."; \
    Flags: runhidden waituntilterminated
; Lancia l'app al primo avvio se l'utente vuole
...
begin
  // Verifica connessione internet (necessaria per scaricare Python/Tesseract)
  Result := True;
  MsgBox('Questa installazione scaricherà e configurerà:' + #13#10 +
